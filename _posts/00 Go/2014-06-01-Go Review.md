...
#### 1.3.4 two types of concurrent programming

[see]({{ site.baseurl}}/00%20go/2014/06/01/Go-Review.html#2-concurrent-programming)
...
##### 2.2.1.2 Solution 2: avoid accessing the variable from multiple goroutines
