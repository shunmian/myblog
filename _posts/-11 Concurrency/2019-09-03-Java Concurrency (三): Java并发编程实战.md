...
{: .img_middle_lg}
![multithreads procedure summary]({{site.url}}/assets/images/posts/-11_Concurrency/2019-09-03-Java Concurrency (三) Java并发编程实战/CountDownLatch & CyclicBarrier.png)
...
> CountDownLatch: 跟团游模式，团长等待各团员就绪后，团长统一进行下一个景点安排； CyclicBarrier, 驴友模式，各驴友就绪后，各个进入下一个景点
