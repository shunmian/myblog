...
> **Q7.1: What does "static" mean?<br/>**
A7.1: for `static variable` and `static void func()` at the file level, it is invisible outsite of the file, only visilbe inside file; for `static variable` inside a function level, once initlized, will persist among multiple call of this function.
...
{: .img_middle_hg}
![13.6 String_Ragged Array]({{site.url}}/assets/images/posts/2014-06-01-C Review/13.6 String_Ragged Array.png)
...
{: .img_middle_hg}
![Chapter 14 The Preprocessor]({{site.url}}/assets/images/posts/2014-06-01-C Review/Chapter 14 The Preprocessor.png)
...
{: .img_middle_hg}
![15.1 header]({{site.url}}/assets/images/posts/2014-06-01-C Review/15.1 header.png)
...
{: .img_middle_hg}
![15.2 header protection]({{site.url}}/assets/images/posts/2014-06-01-C Review/15.2 header protection.png)
...
int main(int argc, char *argv[]){
    ...
    ArrayStruct a1 = {[1,2,3,4]};
    ArrayStruct a2 = {[11,12,13,14]};
...
>**Q18.0: 定义(definition) vs 声明(declaration)
A18.0: 定义只有1个(分配内存)，声明可以多个(通知程序该函数或变量的类型)，定义也是声明，但声明不是定义。
...
//对于函数， 有{}是定义，没有则是声明
extern double max1(double d1,double d2);    //声明
double max2(double d1,double d2);           //声明
double max3(double d1,double d2){           //定义
    return 1.0
}; 
{% endhighlight %} 
...
{: .img_middle_hg}
![15.2 header protection]({{site.url}}/assets/images/posts/2014-06-01-C Review/Chapter 21 The Standard Library.png)

### 3.2 Input/Output ###

{: .img_middle_hg}
![15.2 header protection]({{site.url}}/assets/images/posts/2014-06-01-C Review/Chapter 22 stdio.png)
