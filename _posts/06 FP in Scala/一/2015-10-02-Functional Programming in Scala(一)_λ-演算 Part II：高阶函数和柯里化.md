...
{: .img_middle_mid}
![function and variable]({{site.url}}/assets/images/posts/2015-10-02/function and variable.png)
...
对于为什么有Currying的存在，结合[上篇文章]({{ site.url}}/functional%20programming/2015/10/01/Functional-Programming-in-Scala(一)_λ-演算-Part-I-表达式-函数和赋值.html#calculus)对**λ-Calculus**的介绍，我们来整理下思路：
...
{: .img_middle_mid}
![Currying]({{site.url}}/assets/images/posts/2015-10-02/Currying.png)
