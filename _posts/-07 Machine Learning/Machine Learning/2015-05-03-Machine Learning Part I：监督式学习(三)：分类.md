...
{: .img_middle_lg}
![线性回归map到二分类]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/线性回归map到二分类.png)
...
{: .img_middle_lg}
![logistic function]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/logistic function.png)
...
{: .img_middle_lg}
![Convex vs Non-convex Function]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/Convex vs Non-convex Function.png)
...
{: .img_middle_lg}
![Classification Cost Function.png]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/Classification Cost Function.png)
...
{: .img_middle_lg}
![fminunc]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/fminunc.png)
...
{: .img_middle_lg}
![多分类vs二分类]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/多分类vs二分类.png)
...
{: .img_middle_lg}
![拟合问题]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/拟合问题.png)
...
{: .img_middle_hg}
![regularization]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/regularization.png)
...
我们在[第二篇笔记]({{ site.url}}/machine%20learning/2015/05/02/Machine-Learning(二)-线性回归之多变量.html#normal-equation)中提到过可以由标准方程来求出预测函数，即：
...
{: .img_middle_lg}
![regluarization classification cost function]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/regluarization classification cost function.png)
...
{: .img_middle_lg}
![assignment2]({{site.url}}/assets/images/posts/07_Machine Learning/Machine Learning/2015-05-03/assignment2.png)
